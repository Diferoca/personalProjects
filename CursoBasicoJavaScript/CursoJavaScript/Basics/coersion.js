...
// para este caso JavaScript interpreta que por el uso de el operador + este concatena o une los dos tipos de datos y como resultado tenemos un string.


let c = 4*"7";
console.log(c, typeof c);
// en este caso con el uso del operador matematico * JavaScript interpreta que se debe ejecutar una operacion asumiendo que nos hemos equivocado y que el valor "7" no es un string si no un numero.
